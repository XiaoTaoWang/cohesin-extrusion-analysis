...
def run_hct116_analysis():
    bed_file = f"{PROJECT_ROOT}/script_minji/20260213_from_minji/HCT116-cohesin-specific-regions_20230710_filt_25-75percentile_20231030.bed"
    base_out_dir = f"{PROJECT_ROOT}/aggregation_plot/rescale_3point/HCT116_3point_norm"
    ...
    ctcf_0h = os.path.join(hic_dir, "ENCFF135MUT.cool")
    ctcf_6h = os.path.join(hic_dir, "ENCFF259YUS.cool")
    rad21_0h = os.path.join(hic_dir, "ENCFF528XGK.cool")
    rad21_6h = os.path.join(hic_dir, "ENCFF317OIA.cool")
    ...
    if all(m is not None for m in [mat_rad21_6h, mat_rad21_0h, mat_ctcf_6h, mat_ctcf_0h]):
        ...
        # --- Linear double diff with diagonal scaling ---
        # 1. Scale RAD21_6h to RAD21_0h
